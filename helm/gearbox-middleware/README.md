...
| image.repository | string | `"quay.io/pcdc/gearbox-middleware"` |  |
| image.tag | string | `"test_criterion_patch_Tue__09_Apr_2024_22_32_33_GMT"` |  |
...
| resources.requests.cpu | float | `0.8` |  |
...
| tolerations | list | `[]` |  |
| volumeMounts[0].mountPath | string | `"/gearbox_middleware/gearbox_middleware/keys/jwt_private_key.pem"` |  |
| volumeMounts[0].name | string | `"gearbox-middleware-jwt-keys"` |  |
| volumeMounts[0].readOnly | bool | `true` |  |
| volumeMounts[0].subPath | string | `"jwt_private_key.pem"` |  |
| volumeMounts[1].mountPath | string | `"/gearbox_middleware/.env"` |  |
| volumeMounts[1].name | string | `"config-volume-g3auto"` |  |
| volumeMounts[1].readOnly | bool | `true` |  |
| volumeMounts[1].subPath | string | `"gearbox-middleware.env"` |  |
...
| volumes[0].secret.items[0].key | string | `"jwt_private_key.pem"` |  |
| volumes[0].secret.items[0].path | string | `"jwt_private_key.pem"` |  |
...
| volumes[1].secret.secretName | string | `"gearbox-middleware-g3auto"` |  |
| volumes[2].name | string | `"config-volume"` |  |
| volumes[2].secret.optional | bool | `true` |  |
| volumes[2].secret.secretName | string | `"gearbox-middleware-config"` |  |
